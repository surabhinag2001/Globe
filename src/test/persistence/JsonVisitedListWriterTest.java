...
//        try {
//            VisitedList vl = new VisitedList();
//            vl.addCountry("India", "pretty","09-2001");
//            vl.addCountry("UK", "bigben","09-2001");
//            JsonVisitedListWriter writer = new JsonVisitedListWriter("./data/testWriterGeneralVisitedlistjson");
//            writer.open();
//            writer.write(vl);
//            writer.close();
//
...
//            assertEquals("09-2001", vl.getMyVisitedList().get(0).getDateVisited());
//            assertEquals("UK", vl.getMyVisitedList().get(1).getCountryName());
//            assertEquals("bigben", vl.getMyVisitedList().get(1).getNotesCountry());
//            assertEquals("09-2001", vl.getMyVisitedList().get(1).getDateVisited());
//        } catch (FileNotFoundException e) {
//            fail("Exception should not have been thrown");
//        } catch (IOException e) {
//            //pass
